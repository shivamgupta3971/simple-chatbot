...
def get_response(user_input):
    ...
    if any(greet in user_input for greet in GREETINGS):
        ...
        "how are you" in user_input
        or "how r u" in user_input
        or "you doing" in user_input
    ):
        ...
        "help" in user_input
        or "what can you do" in user_input
        or "commands" in user_input
    ):
        return show_help()
        ...
        "weather" in user_input
        or "temperature" in user_input
        or "forecast" in user_input
    ):
        ...
        "python" in user_input or "programming" in user_input or "coding" in user_input
    ):
